...
public class PersonalDetailPageUI {
    ...
    public static final String PROFILE_IMAGE_UPLOAD_ERROR_MESSAGE = "css=span.oxd-input-field-error-message";
    public static final String EDIT_PROFILE_IMAGE = "css=div.orangehrm-edit-employee-image>img.employee-image";
